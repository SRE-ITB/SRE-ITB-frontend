...
const Speakers = (): JSX.Element => {
  ...
  return (
    <div className="h-auto w-full py-[10vh] flex flex-col gap-48 items-center">
      <div className="flex flex-col gap-20 items-center">
        <div className="flex flex-col gap-[25px] items-center">
          <h2 className="font-[Montserrat-ExtraBold] text-[24px] md:text-[32px] lg:text-[40px] text-green8 text-center">
            Meet Our Speakers
          </h2>
          <h3 className="font-montserrat text-[16px] md:text-[20px] lg:text-[24px] w-[350px] md:w-[500px] lg:w-[1000px] text-center">
            Discover the diverse and accomplished individuals who will be
            sharing their expertise and insights at our event.
          </h3>
        </div>
        <div className="gap-6 grid grid-cols-1 lg:grid-cols-3 justify-items-center">
          {speakers.map((speaker, index) => (
            <div
              ...
              <div className="absolute bottom-0 justify-center items-center w-full h-[100px] flex flex-col text-white bg-gradient-to-b from-transparent to-black">
                <h2 className="font-[Montserrat-ExtraBold] text-[16px] md:text-[18px] lg:text-[20px]">
                  {speaker.name}
                </h2>
                <h3 className="font-montserrat text-[12px] md:text-[13px] lg:text-[14px]">
                  {speaker.desc}
                </h3>
              </div>
            </div>
      ...
      <div className="flex flex-col gap-6 items-center">
        <h2 className="font-[Montserrat-Bold] text-[24px] lg:text-[40px]">
          Contact Us
        </h2>
      ...
      <div className="w-[338px] md:w-full text-[16px] md:text-[20px] lg:text-[24px] font-montserrat font-light flex flex-col gap-6 items-center text-center">
        ...
        <Link href="/">
          <button className="border-[2px] border-green8 font-[Montserrat-Bold] bg-green8 hover:bg-white rounded-sm text-white duration-75 hover:text-green8 font-bold w-[225px] lg:w-[275px] h-[45px] lg:h-[65px] text-[16px] lg:text-[20px]">
            Feedback
          </button>
        </Link>
      </div>

    ...
    <div>       
        <div className='mt-[15vw] sm:mt-0'>
            ...
            <div className='grid grid-rows-2 gap-[6vw] mt-[8vh] sm:mt-[15vw]'>
                <img src={gradient1} alt='gradient1' className='absolute mt-[-15vw] z-10 w-[40vw]'></img>
                ...
                <img src={gradient2} alt='gradient2' className='absolute z-10 mt-[40vh] sm:mt-[8vw] left-[60vw] w-[40vw]'></img>

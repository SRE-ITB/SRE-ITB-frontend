...
import Gradient1 from '@src/assets/Images/About/BehindSRE/Gradient1.svg'
import Gradient2 from '@src/assets/Images/About/BehindSRE/Gradient2.svg'
import Plant from '@src/assets/Images/About/BehindSRE/Plant.svg'

const BehindSRE = (): JSX.Element => {
  return (
        ...
        <div className='grid grid-rows-2 gap-[6vw] mt-[8vw]'>
          ...
          <div className='relative z-30 border-[#89C190] border-[3px] bg-white py-[7vw] p-[5vw] sm:p-[3vw] w-[80vw] sm:w-[60vw] rounded-3xl mx-auto sm:ml-auto sm:mr-[10vw]'>
            <div className='absolute top-[-6vw] right-[5vw] w-[8vw] hidden sm:block'>
              <Image src={Plant} alt='pucuk-logo'/>
            </div>
